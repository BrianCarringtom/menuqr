...
@section('content')
    <style>
        ...
        /* 🔍 BUSCADOR FONDO BLANCO Y CONTORNO ROJO (SIN ZOOM) */
        .search-container {
            position: relative;
            width: 100%;
            max-width: 400px;
    ...
    <div class="users-container">
        ...
        <div class="search-container">
            ...
            <input type="text" id="userSearchInput" placeholder="Buscar por nombre, email o slug..." autocomplete="off">
        </div>
    ...
    <script>
        // RENOVACIÓN ASÍNCRONA POR FETCH (SIN RECARGAR)
        function renewUser(userId) {
            ...
            fetch(`/admin/users/${userId}/renew`, {
                ...
                .then(response => {
                    ...
                    row.classList.remove('row-expired');
                    dateCell.innerHTML = `${formattedDate} (0 días)`;
        ...
        // ⚡ BUSCADOR MEJORADO ANTI-SCROLL INVOLUNTARIO
        const searchInput = document.getElementById('userSearchInput');

        searchInput.addEventListener('input', function(e) {
            // Evitamos propagaciones o rebotes que fuercen saltos de página
            e.preventDefault();
            e.stopPropagation();
        ...
        // Asegura congelar la ventana bloqueando eventos de scroll automáticos del navegador mientras escribes
        ...
        // Guardar Scroll en envíos manuales de formularios
