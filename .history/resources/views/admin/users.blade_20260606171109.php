                    ...
                    @foreach ($users as $user)
                        <tr>
                            <td style="text-align: center;">
                                {{-- Condición: Si NO es admin y lleva 29 días o más, muestra la bandera --}}
                                @if ($user->role !== 'admin' && \Carbon\Carbon::parse($user->created_at)->diffInDays(\Carbon\Carbon::now()) >= 29)
