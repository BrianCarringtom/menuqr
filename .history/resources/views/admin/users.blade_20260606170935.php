                    ...
                    @foreach ($users as $user)
                        <tr>
                            <td style="text-align: center;">
                                {{-- Forzamos la conversión a Carbon para asegurar que el cálculo matemático de días funcione al 100% --}}
                                @if (\Carbon\Carbon::parse($user->created_at)->diffInDays(\Carbon\Carbon::now()) >= 29)
                                    <i class="fa-solid fa-flag" style="color: #ef4444 !important; display: inline-block;"
                                        title="Vence pronto (29 días o más)"></i>
                                @endif
                            </td>
                            <td>{{ $user->id }}</td>
                            <td>{{ $user->name }}</td>
