...
<body data-page="{{ $page ?? 'dashboard' }}">
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            // Cambia el icono a X o vuelve a hamburguesa
            if (sidebar.classList.contains('show')) {
                hamburgerBtn.classList.remove('fa-bars');
                hamburgerBtn.classList.add('fa-times'); // X
            } else {
                hamburgerBtn.classList.remove('fa-times');
                hamburgerBtn.classList.add('fa-bars'); // Hamburguesa
            }
        }

        // Opcional: cerrar sidebar al tocar fuera
