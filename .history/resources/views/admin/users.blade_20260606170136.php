...
@section('content')
    <style>
        ...
        .search-container input {
            ...
            /* Texto oscuro */
            font-size: 16px;
            /* 👈 ¡Cambiado a 16px para evitar que el móvil haga zoom! */
            font-weight: 500;
    ...
    <script>
        // 🔥 RENOVACIÓN ASÍNCRONA POR FETCH (SIN RECARGAR NI SUBIR LA PÁGINA)
        ...
        // ⚡ BUSCADOR EN TIEMPO REAL (NO SUBE LA PÁGINA, FILTRA DIRECTO EN LA TABLA ABAJO)
