            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($user->qr_path)
                            @php
                                $qrUrl = asset('storage/' . $user->qr_path);
                            @endphp
                            {{-- Mostrar QR SVG directamente --}}
                            {!! file_get_contents(storage_path('app/public/' . $user->qr_path)) !!}
                            <br>
                            {{-- Enlace para descargar --}}
                            <a href="{{ $qrUrl }}" download="QR_{{ $user->slug }}.svg">
                                Descargar QR
                            </a>
                        @endif
                    </td>
