...
@section('content')
            ...
            <table class="custom-table" id="usersTable">
                ...
                <tbody>
                    @php
                        ...
                        // Separamos usuarios en caliente según los días transcurridos
                        ...
                        // Los usuarios por vencer se fusionan arriba de todo
    ...
    <script>
        ...
        // Guardado de posición del Scroll al enviar formularios
