...
<head>
    ...
    <style>
        :root {
            ...
            --price-color: #10b981; /* Verde éxito elegante para precios */
        }
        ...
        * {
        ...
        @keyframes pulse {
            0% { transform: scale(1); }
            100% { transform: scale(1.04); border-color: var(--accent-secondary); }
        }
        ...
        .tab-image-wrapper {
            ...
            width: 72px;
            height: 72px;
            border-radius: 24px; /* Estilo squircle moderno */
            padding: 4px;
            background: var(--card-bg);
            border: 2px solid transparent;
            transition: all 0.3s ease;
