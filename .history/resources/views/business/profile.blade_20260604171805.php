            ...
            try {
                ...
                img.onload = function() {
                    ...
                    const drawCanvasContent = () => {
                        ...
                        // Capa translúcida ultra clara para mantener la fidelidad de la imagen
                        ...
                        ctx.save();
                        // Sombra para despegar el texto completamente del fondo claro
                        ...
                        ctx.fillStyle =
                        "#1520A6"; // Cambiado a tu azul de marca para que se lea perfecto en fondos claros
                        ...
                        ctx.fillStyle = "#1520A6"; // Cambiado a tu azul de marca para mejor contraste
                        ctx.font = `bold 42px ${systemFont}`;
                        ctx.fillText("Escanea el código QR", titleX, 1260);
                        ctx.restore();

                        // Píldora de la URL estilizada en azul semi-translúcido claro
                        ...
                        ctx.fillStyle =
                        "#0A0F52"; // Texto oscuro para que se lea sobre la píldora clara
                    ...
                    if (coverUrl) {
                        ...
                        cover.onload = function() {
                            // Se dibuja la imagen de fondo limpia, original y clara
