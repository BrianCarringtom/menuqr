...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* CABECERA ROSA PREMIUM CON DEGRADADO FESTIVO */
        .brand-header {
            text-align: center;
            padding: 60px 20px 45px;
            /* Degradado Rosa Premium: Desde un rosa mexicano vibrante hasta un lila/morado pastel muy chic */
            background: linear-gradient(135deg, #ff007f 0%, #ff40a0 40%, #7b2cbf 100%);
            
            /* Sutil patrón de destellos brillantes de fondo */
            ...
            margin-bottom: 30px;
            overflow: hidden; /* Mantiene las figuras dentro del marco visual */
        }

        /* --- FIGURAS DE PIÑATAS Y GLOBOS A LOS LADOS --- */
        
        /* Piñata izquierda (Estilo estrella clásica con iconos) */
        .brand-header::before {
            content: "\f8a2"; /* Icono de piñata/regalo/fiesta en FontAwesome (o estrella en su defecto) */
        ...
        /* Globo derecho */
        .brand-header::after {
            content: "\f556"; /* Icono de Globo (Balloon) en FontAwesome */
            font-family: "Font Awesome 6 Free";
            font-weight: 900;
            position: absolute;
            right: 8%;
            top: 30%;
            font-size: 36px;
            color: rgba(255, 214, 0, 0.8); /* Amarillo vibrante para que contraste con el rosa */
            filter: drop-shadow(-2px 4px 6px rgba(0,0,0,0.15));
            animation: floatRight 4.5s ease-in-out infinite alternate;
        }

        /* Animaciones estéticas de flotación suave */
        @keyframes floatLeft {
        ...
        /* CONTENEDOR DEL LOGO / IMAGEN (Mantiene la forma circular premium) */
        .brand-logo-shape {
            display: inline-flex;
            align-items: center;
            ...
            border-radius: 50%;
            padding: 3px; /* Espacio para que la foto se vea enmarcada */
            margin-bottom: 15px;
            box-shadow: 0 8px 25px rgba(0, 0, 0, 0.2);
            position: relative;
            z-index: 2;
            animation: swingLogo 3s ease-in-out infinite alternate;
        }
        ...
        /* TEXTO DEL TITULO (Elegante y limpio sobre el fondo rosa) */
        .brand-name {
            font-family: 'Fredoka', sans-serif;
            font-size: 38px;
            color: var(--text-white);
            font-weight: 700;
            /* Sombra suave y limpia para que resalte perfectamente en el rosa */
            text-shadow: 2px 2px 0px rgba(123, 44, 191, 0.8), 4px 4px 10px rgba(0, 0, 0, 0.2);
            line-height: 1.1;
            position: relative;
            z-index: 2;
        }
