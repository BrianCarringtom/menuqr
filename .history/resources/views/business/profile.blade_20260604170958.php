            ...
            try {
                ...
                img.onload = function() {
                    ...
                    const drawCanvasContent = () => {
                        ...
                        ctx.strokeStyle = "rgba(21, 32, 166, 0.25)";
                        ctx.lineWidth = 3;
                        ctx.stroke();
                        ...
                        // Gradiente de azul de 4 pasos (simula reflejo metálico cromado)
                        const blueGlow = ctx.createLinearGradient(0, titleY - 60, 0, titleY + 20);
                        blueGlow.addColorStop(0, '#FFFFFF'); // Brillo máximo
                        blueGlow.addColorStop(0.3, '#1520A6'); // Azul base
                        blueGlow.addColorStop(0.6, '#0A0F52'); // Sombra azul profunda
                        blueGlow.addColorStop(1, '#E0E7FF'); // Reflejo inferior suave
                        ...
                        ctx.strokeStyle = "rgba(21, 32, 166, 0.3)";
                        ctx.stroke();
                        ...
                        // Botón inferior "ESCANEA Y VISÍTANOS" con relieve metálico azul
                        ctx.save();
                        ctx.shadowColor = "rgba(0,0,0,0.4)";
                        ctx.shadowBlur = 20;
                        ctx.shadowOffsetY = 8;
                        ...
                        btnGrad.addColorStop(0, '#1520A6');
                        btnGrad.addColorStop(0.5, '#2A37D9');
                        btnGrad.addColorStop(1, '#0A0F52');
                    ...
                    if (coverUrl) {
                        ...
                        cover.onload = function() {
                            ...
                            // Capa oscura ambiental fría para unificar el fondo con la paleta azul
