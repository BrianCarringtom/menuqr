...
<head>
    ...
    <style>
        body {
            background: url('https://images.unsplash.com/photo-1525789351284-e1e7de240152?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHVuc3BsYXNofGVufDB8fDB8fHww') center/cover no-repeat fixed;
        }
    </style>
</head>
...
<body class="min-h-screen flex items-center justify-center px-4 py-10">
    ...
    <!-- CONTENEDOR -->
    <div class="w-full max-w-5xl bg-gradient-to-br from-orange-50 to-orange-100 backdrop-blur-lg text-gray-800 p-6 md:p-10 rounded-2xl shadow-xl border border-orange-200">
