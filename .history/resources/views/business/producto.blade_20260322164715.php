        ...
        ">
            ...
            ">
                ...
                ">
                    ...
                    <p style="color:#6b7280; font-size:14px; margin-bottom:20px;">
                        Registra nuevos productos en tu catálogo.
                    </p>
                    ...
                    <form method="POST" action="/business/product"
                        ...
                        <input type="text" name="name" placeholder="Nombre del producto" required
                            style="padding:12px; border-radius:10px; border:1px solid #d1d5db; background:#fafafa;">
                        ...
                        <textarea name="description" rows="4" placeholder="Descripción del producto" required
                            style="padding:12px; border-radius:10px; border:1px solid #d1d5db; background:#fafafa;"></textarea>
