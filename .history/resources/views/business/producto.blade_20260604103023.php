...
<head>
    ...
    <style>
        * {
        ...
        textarea:focus {
            border-color: #06b6d4;
            box-shadow: 0 0 0 3px rgba(6, 182, 212, 0.15), inset 0 2px 4px rgba(0, 0, 0, 0.2);
...
<body>
            ...
            <div class="grid">
                ...
                <div class="box">
                    ...
                    <form method="POST" action="/business/category" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn-gold" style="margin-top:10px;">Crear Categoría</button>
                    </form>
                </div>
                ...
                <div class="box">
                    ...
                    <form method="POST" action="/business/product">
                        ...
                        <button type="submit" class="btn-gold">Agregar Producto</button>
                    </form>
                </div>
    ...
    <script>
        ...
        // FUNCIONES DE MENÚ FIJAS (SIN INTERRUPCIÓN EN REDIMENSIONAMIENTO)
        function toggleMenu() {
