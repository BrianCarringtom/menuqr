...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* CABECERA ESTILO PIÑATA ARTESANAL PREMIUM */
        .brand-header {
            text-align: center;
            padding: 60px 20px 45px;
            /* Degradado mejorado: Más profundo y vibrante */
            background: linear-gradient(135deg, #1a0033 0%, #3a0ca3 50%, #ff007f 100%);
            /* Patrón de figuras geométricas sutiles de fondo */
            background-image: 
                radial-gradient(rgba(255, 255, 255, 0.15) 15%, transparent 16%),
                radial-gradient(rgba(255, 214, 0, 0.1) 15%, transparent 16%);
            ...
            margin-bottom: 30px;
            overflow: hidden; /* Para que las figuras decorativas no se salgan */
        }

        /* FIGURAS BONITAS FLOTANTES DE FONDO (Rombo e Iconos) */
        .brand-header::before {
            content: "✦";
            font-size: 28px;
            ...
            left: 15%;
            opacity: 0.6;
            animation: spinDecor 6s linear infinite;
        }

        /* Otra figura decorativa al lado derecho (Un rombo brillante) */
        .brand-header .brand-name::before {
            content: "";
            position: absolute;
            width: 15px;
            height: 15px;
            ...
            animation: floatDecor 4s ease-in-out infinite alternate;
        }
        ...
        /* Borde inferior dentado (Estilo papel picado / Bordes de imagen.jpg) */
        .brand-header::after {
            content: "";
            position: absolute;
            bottom: -12px;
        ...
        /* CONTENEDOR DEL LOGO / IMAGEN CON NUEVA FORMA GEOMÉTRICA (Octágono / Estrella) */
        .brand-logo-shape {
            display: inline-flex;
            align-items: center;
            ...
            /* Cambio de forma: Ahora tiene un estilo poligonal/geométrico hermoso */
            clip-path: polygon(50% 0%, 83% 12%, 100% 43%, 94% 78%, 68% 100%, 32% 100%, 6% 78%, 0% 43%, 17% 12%);
            border: 3px solid var(--text-white); /* Nota: El clip-path puede cortar el borde clásico, usamos box-shadow interno o un contenedor limpio */
            
            margin-bottom: 18px;
            box-shadow: 0 8px 25px rgba(255, 111, 0, 0.7);
            position: relative;
            z-index: 2;
        ...
        /* TEXTO DEL TITULO CON SOMBRAS MULTICAPA */
        .brand-name {
            ...
            /* Sombras dinámicas que simulan el relieve 3D de las piñatas */
            text-shadow: 
                3px 3px 0px var(--pinata-orange), 
                6px 6px 0px var(--pinata-purple), 
