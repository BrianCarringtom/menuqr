...
<body>
    ...
    ">
            ...
            <!-- 🔥 FORM OCULTO -->
            <div class="card">
                <h3 style="margin-bottom:15px;">Actualizar imagen</h3>
            ...
            <div class="cards-row">
                ...
                <div class="card" style="transition:0.3s;">
                    <h3>Tu negocio</h3>
                    <p>Personaliza tu imagen para atraer más clientes.</p>
                </div>

                <div class="card">
                    <h3>Consejo PRO</h3>
                    <p>Usa imágenes HD (mínimo 1200px) para mejor calidad.</p>
                </div>
