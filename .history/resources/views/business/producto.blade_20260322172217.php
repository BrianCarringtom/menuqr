                ...
                <div class="box">
                    ...
                    @if (auth()->user()->products->count())
                        <div style="margin-top:20px;">
                            ...
                            <div
                                style="display:flex; flex-direction:column; gap:10px; max-height:200px; overflow:auto;">
                                @foreach (auth()->user()->products as $product)
                                    <div
                                        style="padding:12px; background:#f9fafb; border:1px solid #e5e7eb; border-radius:10px;">
