...
<body>
    ...
    <section class="relative min-h-screen overflow-hidden">
        ...
        <!-- Overlay -->
        <div class="absolute inset-0 bg-gradient-to-t from-[#060606] via-[#060606]/70 to-[#060606]/20">
        </div>

        <!-- Header -->
        <div class="absolute top-0 left-0 right-0 z-30 flex justify-between items-center px-8 py-6">
            ...
            <a href="https://wa.me/{{ $user->whatsapp }}" target="_blank"
                class="bg-white text-black px-5 py-3 rounded-full font-semibold hover:scale-105 transition">
        ...
        <div class="relative z-20 min-h-screen flex items-end">
            ...
            <div class="max-w-4xl px-8 pb-24">

                <span class="inline-block bg-red-600 text-white px-4 py-2 rounded-full text-sm font-bold mb-6">

                    DESTACADO

                </span>

                <h1 class="text-5xl md:text-8xl font-black leading-none mb-8">
                ...
                <p class="text-lg md:text-2xl text-gray-300 max-w-2xl mb-10">
                    ...
                    y servicios desde cualquier dispositivo.
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="https://wa.me/{{ $user->whatsapp }}" target="_blank"
                        class="bg-white/10 backdrop-blur-xl border border-white/10 px-8 py-4 rounded-2xl font-bold">
