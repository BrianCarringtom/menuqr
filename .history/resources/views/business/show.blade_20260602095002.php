...
<head>
    ...
    <style>
        :root {
            --bg: #050505;
            --card: #0f0f10;
            --card-light: rgba(255, 255, 255, .04);
        ...
        * {
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(600px circle at 20% 10%,
                    rgba(251, 191, 36, .08),
                    transparent),
                radial-gradient(500px circle at 90% 20%,
                    rgba(255, 255, 255, .04),
                    transparent);
            pointer-events: none;
            z-index: -1;
...
========================= */
        ...
        .hero-button {
            ...
            box-shadow:
                0 10px 30px rgba(251, 191, 36, .25);
        ...
        .hero-button:hover {
            ...
            box-shadow:
                0 16px 40px rgba(251, 191, 36, .35);
        }
