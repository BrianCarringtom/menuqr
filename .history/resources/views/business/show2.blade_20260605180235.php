...
<head>
    ...
    <style>
        :root {
            --bg-main: #34b3e4;
            /* Azul vibrante inspirado en el fondo de la imagen */
            --text-dark: #0f3d59;
            /* Azul oscuro para tipografía de categorías */
            --text-light: #ffffff;
        ...
        * {
        ...
        .background-logo-watermark {
            ...
            opacity: 0.12;
            /* Efecto marca de agua sutil de fondo */
            z-index: 0;
            pointer-events: none;
            filter: grayscale(30%);
        }
        ...
        /* ESTRUCTURA ASIMÉTRICA ALTERNADA (TIPO LA IMAGEN) */
        .menu-layout-wrapper {
            position: relative;
            z-index: 10;
        ...
        /* Bloque contenedor de categoría */
        .category-block {
            display: flex;
            flex-direction: column;
            width: 100%;
        ...
        /* Intercalado dinámico usando CSS para cambiar orden izquierda/derecha */
        ...
        /* DISEÑO DE LAS TARJETAS DE PRODUCTOS ORIGINALES */
        .product-card {
        ...
        /* FOOTER PREMIUM RE-ESTRUCTURADO */
        .premium-footer {
...
<body>
    ...
    <main class="menu-layout-wrapper" id="contenedor-paneles">
        ...
        @forelse ($user->categories as $index => $category)
            <div class="category-block" id="panel-{{ $index }}">
                ...
                <div class="category-header-row">
                    ...
                    <div class="category-title-info">
                        ...
                        <span class="category-meta-size">Porción Regular 16oz</span>
                    </div>
                </div>
        ...
        function buscarEnTiempoReal() {
            ...
            if (query.length > 0) {
                blocks.forEach(block => {
                    ...
                    // Si la categoría tiene resultados, la dejamos visible, si no, se oculta por completo
