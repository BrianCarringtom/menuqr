...
<body>
    ...
    <section class="h-screen relative flex items-center justify-center text-center overflow-hidden mobile-spacing">
        ...
        <!-- 💬 WHATSAPP -->
        <a href="https://wa.me/5219610000000" target="_blank" class="absolute bottom-6 right-6 z-30 group">

            <div
                class="flex items-center gap-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-5 py-3 rounded-full shadow-[0_10px_35px_rgba(37,211,102,0.45)] transition duration-300 hover:scale-105">

                <!-- ICONO -->
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">

                    <path
                        d="M20.52 3.48A11.82 11.82 0 0012.04 0C5.4 0 .06 5.34.06 11.94c0 2.1.54 4.14 1.56 5.94L0 24l6.3-1.62a11.88 11.88 0 005.7 1.44h.06c6.6 0 11.94-5.34 11.94-11.94 0-3.18-1.26-6.18-3.48-8.4zM12.06 21.78a9.9 9.9 0 01-5.04-1.38l-.36-.24-3.72.96.96-3.6-.24-.36a9.78 9.78 0 01-1.5-5.22c0-5.4 4.44-9.78 9.9-9.78 2.64 0 5.1 1.02 6.96 2.88a9.78 9.78 0 012.88 6.96c0 5.46-4.44 9.9-9.84 9.9zm5.4-7.38c-.3-.18-1.8-.9-2.1-.96-.24-.12-.48-.18-.72.18-.18.3-.78.96-.96 1.14-.18.24-.36.24-.66.06-.3-.18-1.32-.48-2.46-1.56-.9-.78-1.5-1.8-1.68-2.1-.18-.3 0-.48.12-.66.18-.18.3-.36.48-.54.12-.18.18-.3.3-.54.06-.18 0-.42-.06-.6-.06-.18-.72-1.74-.96-2.4-.24-.6-.48-.54-.72-.54h-.6c-.18 0-.48.06-.72.3s-.96.96-.96 2.34.96 2.7 1.08 2.88c.12.18 1.92 3 4.74 4.08.66.3 1.2.48 1.62.6.72.24 1.38.18 1.92.12.6-.06 1.8-.72 2.04-1.44.24-.72.24-1.32.18-1.44-.06-.12-.24-.18-.54-.36z" />
                </svg>

                <!-- TEXTO -->
                <span class="hidden md:block font-medium tracking-wide">
                    Contáctanos
                </span>
