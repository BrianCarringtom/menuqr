...
<div class="main">
    ...
    <div class="cards-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: stretch;">
        ...
        <div class="card" style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
            ...
            <p style="color: #555; margin-bottom: 15px;">Crea nuevas categorías para tus productos y organiza tu negocio.</p>
            <form id="category-form" style="display: flex; flex-direction: column; gap: 15px;">
                <input type="text" name="category" placeholder="Nombre de la categoría" 
                       style="padding: 12px; border-radius: 8px; border: 1px solid #ddd; font-size: 16px;" required>
                <button type="submit" style="padding: 12px; border-radius: 8px; border: none; background: #c9a227; color: white; font-weight: 600; cursor: pointer; transition: 0.25s;">
                    Crear Categoría
                </button>
            </form>
        </div>
        ...
        <div class="card">
            ...
            <p style="color: #555; margin-bottom: 15px;">Agrega nuevos productos con todos los detalles para mostrarlos en tu tienda.</p>
