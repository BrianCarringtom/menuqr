    ...
    <style>
        ...
        * {
        ...
        .main-app-container {
            ...
            flex: 1;
            position: relative;
            /* Fijamos la altura de la zona de la app restando el header para controlar el scroll exacto */
            height: calc(100vh - 117px);
            overflow: hidden;
        }

        /* COLUMNA IZQUIERDA: DISEÑO PARA MOSTRAR EXACTAMENTE 5 ELEMENTOS CON SCROLL */
        .sidebar-categories {
            width: 110px;
        ...
        /* Botón de categoría rediseñado proporcionalmente para encajar en la regla de 5 visibles */
        .category-tab-btn {
            display: flex;
            flex-direction: column;
            align-items: center;
            ...
            border-radius: 18px;
            /* Cálculo matemático para forzar que entren exactamente 5 botones en el alto de la columna */
            height: calc((100% - (12px * 4)) / 5);
            min-height: 75px;
            /* Respaldo de seguridad en pantallas ultra pequeñas */
            padding: 6px 4px;
            cursor: pointer;
            outline: none;
            gap: 6px;
            ...
            flex-shrink: 0;
            /* Evita que se colapsen o reduzcan */
        }
        ...
        .category-tab-btn.active {
            ...
            box-shadow: 0 6px 20px rgba(224, 122, 52, 0.4);
        ...
        /* COLUMNA DERECHA: SECCIÓN DE CONTENIDOS CON SCROLL INDEPENDIENTE */
        .content-area {
            flex: 1;
            display: flex;
            flex-direction: column;
            ...
            overflow-y: auto;
            /* Scroll independiente de los productos */
        }
        ...
        @media(min-width: 768px) {
            ...
            .category-tab-btn {
                ...
                gap: 12px;
                height: auto;
                /* En pantallas grandes dejamos que respire naturalmente */
                min-height: auto;
            }
