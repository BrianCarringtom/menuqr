        ...
        <div class="main">
            ...
            <div class="welcome-box">
                ...
                <div class="welcome-content">
                    <h1>Panadería La Delicia</h1>
                    <h2>Propietario: Juan Pérez</h2>
                    <p><strong>Slogan:</strong> "El sabor que te hace sonreír"</p>
                    <p><strong>Dirección:</strong> Calle Falsa 123, Ciudad de México</p>
                    <p><strong>Teléfono:</strong> +52 55 1234 5678</p>
                    <p><strong>Ubicación:</strong>
                        <a href="https://goo.gl/maps/xyz123" target="_blank">Ver en Google Maps</a>
                    </p>
                </div>
            </div>
