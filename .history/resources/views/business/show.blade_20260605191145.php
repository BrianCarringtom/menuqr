...
<head>
    ...
    <style>
        :root {
            ...
            --text-muted: #64748b;
            --accent-color: #3b82f6;
            /* Azul corporativo neutro universal */
            --border-color: #e2e8f0;
        }
        ...
        * {
        ...
        /* CONTENEDOR GRID OBLIGATORIO DE 2 EN 2 POR FILA */
        .categories-grid {
            display: grid;
        ...
        /* CONTENEDOR DESPLEGABLE QUE SE EXPANDE ABARCANDO LAS 2 COLUMNAS */
        ...
        /* TARJETAS DE PRODUCTOS / SERVICIOS NEUTROS */
        .product-card {
        ...
        /* SECCIÓN DE INFORMACIÓN COMPLEMENTARIA (FOOTER) */
        .premium-footer {
            background: var(--card-bg);
    ...
    <div class="categories-grid" id="menu-categorias">
                ...
                <div class="products-list">
                    ...
                    @empty
                        <p
                            ...
                            No hay registros disponibles en esta categoría actualmente.
                        </p>
                    @endforelse
                </div>
            </div>
        ...
        @empty
            <div class="text-center" style="color: var(--text-muted); padding: 40px 20px; grid-column: span 2;">
                <p style="font-size: 14px;">No hay datos cargados en este momento.</p>
            </div>
        @endforelse
    </div>
