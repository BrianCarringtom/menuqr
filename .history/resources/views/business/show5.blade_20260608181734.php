...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* HEADER PREMIUM - AHORA HACE SCROLL CON LA PÁGINA (SIN FIXED/STICKY) */
        .brand-header {
            display: flex;
            align-items: center;
            gap: 18px;
            ...
            position: relative;
            /* Cambiado de sticky a relative para que suba al hacer scroll */
            z-index: 100;
        }
        ...
        .main-app-container {
            ...
            flex: 1;
            position: relative;
            /* Ahora que el header se va, el alto pasa a ocupar el viewport disponible completo */
            height: calc(100vh - 20px);
            overflow: hidden;
        }

        /* COLUMNA IZQUIERDA: MUESTRA 5 ELEMENTOS VISIBLES CON SCROLL VERTICAL PROPIO */
        .sidebar-categories {
            width: 110px;
        ...
        /* Botón calculado matemáticamente para que entren exactamente 5 en el alto de la pantalla libre */
        .category-tab-btn {
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        /* COLUMNA DERECHA: PRODUCTOS CON SCROLL PROPIO INDEPENDIENTE */
        .content-area {
            flex: 1;
            display: flex;
            flex-direction: column;
