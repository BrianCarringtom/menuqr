    ...
    <style>
        ...
        * {
        ...
        .search-input {
            ...
            border-radius: 0px;
            /* Estilo retro/comiquita sin bordes redondos */
        ...
        /* NUEVA ESTRUCTURA DE PRODUCTOS: DISEÑO DE BLOQUES/AFICHE */
        .products-container {
        ...
        .category-products-panel {
            display: none;
            /* Grid de dos columnas para pantallas medianas/grandes, 1 columna en móviles */
        ...
        /* Efecto de mancha decorativa azul aleatoria en las esquinas */
        .product-card::before {
            content: "";
            position: absolute;
            top: -8px;
        ...
        /* Contenedor de precio destacado abajo a la derecha del bloque */
        ...
        /* SECCIÓN DE HORARIOS Y MAPA (ESTILO CARTELERA) */
        .premium-footer {
            background: var(--white);
...
<body>
    ...
    <section class="brand-section">
        <div class="main-banner-title">MENU</div>
        <h1 class="brand-title">{{ $user->name }}</h1>
        <p class="brand-subtitle">BAR & RESTAURANT</p>
    </section>

    <div class="search-box-container">
        <div class="search-wrapper">
            <i class="fa-solid fa-magnifying-glass"></i>
            <input type="text" id="input-busqueda" class="search-input" placeholder="¿Qué vas a pedir hoy?..."
            ...
            <div class="category-products-panel {{ $index == 0 ? 'active' : '' }}" id="panel-{{ $index }}">
                ...
                @empty
                    <p
                        ...
                        No hay productos aquí por el momento.
                    </p>
                @endforelse
            </div>
        @empty
            ...
            if (query.length > 0) {
                panels.forEach((panel, index) => {
                    ...
                    if (tieneCoincidencias > 0) {
                        panel.style.display = 'grid'; // Asegura mantener el layout grid al buscar
