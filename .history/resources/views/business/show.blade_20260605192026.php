...
<head>
    ...
    <style>
        :root {
            ...
            /* Amarillo de los banderines/acentos */
            --texto-oscuro: #3a2512;
        ...
        * {
        ...
        /* CABECERA ESTILO IMAGEN_2.JPG ENFOCADO EN EL NOMBRE */
        .brand-section {
            text-align: center;
...
<body>
    ...
    <!-- Sección de Marca (Limpia sin la palabra "Menú") -->
    ...
    <div class="categories-grid" id="menu-categorias">
                    ...
                    <div class="products-list">
                        ...
                        @empty
                            <div class="product-card"
                                ...
                                <p style="font-size: 13px; opacity: 0.7;">Próximamente más opciones en esta sección.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
        ...
        @empty
            <div style="grid-column: span 2; text-align: center; padding: 40px 20px; opacity: 0.7;">
                <p>El catálogo se encuentra en actualización. ¡Vuelve pronto!</p>
            </div>
        @endforelse
    </div>
