...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Capa de fondo fija con marca de agua estilo logo orgánico */
        body::before {
            content: "";
            position: fixed;
            top: 0;
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(rgba(28, 14, 11, 0.90), rgba(28, 14, 11, 0.96)),
        ...
        /* Capa secundaria para degradado ambiental */
        body::after {
            content: "";
            position: fixed;
            top: 0;
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 70% 20%, rgba(61, 33, 25, 0.4) 0%, rgba(28, 14, 11, 0) 60%);
            z-index: -2;
        }
        ...
        /* CONTENEDOR APP DOS COLUMNAS (SPLIT LAYOUT) */
        .main-app-container {
            display: flex;
            flex: 1;
            position: relative;
        ...
        /* COLUMNA IZQUIERDA: CATEGORÍAS TIPO APP BAR LATERAL */
        .sidebar-categories {
            width: 105px;
        ...
        /* Botón de Categoría Vertical Rediseñado */
        .category-tab-btn {
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        /* Estado Activo de Categorías */
        .category-tab-btn.active .tab-image-wrapper {
            background: var(--accent-orange);
            border-color: var(--accent-orange);
            box-shadow: 0 0 0 2px var(--bg-main), 0 8px 20px rgba(224, 122, 52, 0.45);
        ...
        /* CONTENEDOR DE PRODUCTOS ESTILO CARTA MINIMAL (IMAGEN 1 Y 2) */
        .products-container {
            width: 100%;
        }
        ...
        /* Cuando está activa, se muestra el panel con animación orgánica */
        ...
        /* CARTA DE PRODUCTOS CON PUNTOS DE GUÍA (ESTILO HISTÓRICO RESTAURANTE/BARBER) */
        .product-card {
            display: flex;
            flex-direction: column;
            width: 100%;
        ...
        /* Línea punteada de unión clásica entre texto y costo */
        .product-leader {
            flex-grow: 1;
        ...
        /* FOOTER DE ALTO NIVEL OCUPANDO EL ANCHO COMPLETO */
        .premium-footer {
            background: #120806;
            padding: 45px 24px;
        ...
        /* RESPONSIVE DESIGN AVANZADO: ESCALADO DE TABLERO PARA PANTALLAS GRANDES */
