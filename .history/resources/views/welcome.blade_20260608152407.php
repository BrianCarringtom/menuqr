...
<body>
    ...
    <section class="hero" id="inicio">
        ...
        <div class="hero-content">
            ...
            <div class="hero-badge">
                ...
                CarringtomTech Expertos en desarrollo
            </div>
            ...
            <p>
                Impulsamos tu empresa con aplicaciones móviles, páginas web y sistemas inteligentes a medida.
            </p>
    ...
    <section class="section" id="servicios">
        ...
        <div class="section-title">
            ...
            <p>
                Soluciones digitales premium para potenciar tu marca, optimizar procesos y aumentar tus ventas.
            </p>
        </div>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p>Páginas web y sistemas robustos, rápidos y a medida.</p>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h3>Apps Móviles</h3>
                    <p>Aplicaciones nativas e híbridas de alto rendimiento.</p>
                    <button>Ver más</button>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h3>Marketing</h3>
                    <p>Estrategias digitales para posicionar tu marca y vender más.</p>
                    <button>Ver más</button>
                </div>
            </div>
    ...
    <section class="contact" id="contacto">
        ...
        <div class="contact-container">
            ...
            <!-- FORM -->
            <form class="contact-form" action="https://formsubmit.co/TUCORREO@gmail.com" method="POST">
